...
def test_subcontribution_details_carry_references(dummy_event, dummy_contribution, referenced_subcontribution,
                                                  token_headers, test_client):
    resp = test_client.get(f'/api/v1/events/{dummy_event.id}/contributions/{dummy_contribution.id}'
                           f'/subcontributions/{referenced_subcontribution.id}', headers=token_headers)
...
def test_subcontribution_matches_current_api(dummy_event, dummy_contribution, referenced_subcontribution,
    ...
    new = test_client.get(f'/api/v1/events/{dummy_event.id}/contributions/{dummy_contribution.id}'
                          f'/subcontributions/{referenced_subcontribution.id}', headers=token_headers).json
...
def test_subcontribution_list_matches_current_api(dummy_event, dummy_contribution, referenced_subcontribution,
