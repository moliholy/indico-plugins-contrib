...
ENDPOINTS = [
    ...
    Endpoint(rule='/events/<int:event_id>/document-templates/<int:template_id>', name='document_template',
             rh=RHDocumentTemplate, schema=DocumentTemplateSchema, summary='Document template details',
             tag='Documents'),
    ...
    Endpoint(rule='/events/<int:event_id>/registrations/<int:registration_id>/documents/<int:file_id>',
             name='document', rh=RHDocument, schema=DocumentSchema, summary='Document details', tag='Documents'),
]
